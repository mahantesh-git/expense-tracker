  ...
  return (
    <div className="p-4 md:p-6 space-y-5 w-full page-enter">
      <div className="flex items-start justify-between gap-4 mb-2">
        <div>
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: 'var(--text-primary)' }}>I Paid</h1>
          <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>{expenses.length} bills paid upfront</p>
        </div>
